...
router.post("/filtrotalle", function(req, res){

  let perPage = 8;
  let page = req.params.page || 1;

  var flrtName = req.body.talle;
...
router.get('/shopcart', function (req, res, next){
  ...
  res.render('cart/shopcart', {products: cart.generateArray(), totalPrice: cart.totalPrice, totalShip: cart.totalShip})
});
