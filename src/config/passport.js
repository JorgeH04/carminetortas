...
passport.use(new GoogleStrategy({
 //clientID: process.env.G_clientID,
  clientID: '311324099153-v69lj7osnijc2opggprirba6u34qtaqm.apps.googleusercontent.com',
 // clientSecret:process.env.G_clientSecret,
 clientSecret:'eJTjVgnIly1iwC-2F_lbQcJ5',
...
passport.use(new facebookStrategy({
  ...
  //clientID:'FBCLIENT',
  clientID        : '3343266189052995',
  //clientSecret:'FBSECRET',
  clientSecret    : '950639fe7cd8f9de55389e686b919d32',
